// app/customers/flowers/detail/page.tsx
'use client';
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-12 p-6 md:p-12 max-w-7xl mx-auto">
      ...
      <div className="flex-1">
        <Image
          src="/bunga-preview.png" // Simpan gambar sebagai bunga-preview.png di /public
          alt="Bellissimo"
          width={600}
          height={600}
      ...
      <div className="flex-1 space-y-6">
        <h1 className="text-4xl font-bold text-gray-900">Bellissimo</h1>
        <h2 className="text-xl text-gray-700 font-semibold">
          Huge Fresh Flower Bouquet
        </h2>
        <p className="text-lg text-pink-600 font-bold">Rp1.500.000,00</p>
